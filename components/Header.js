    ...
    return (
        <header
         ...
         shadow-md bg-white'>
            ...
            <h1
                className="ml-2 text-gray-700 text-2xl">Docs</h1>
            ...
            focus-within:shadow-md">
                <Icon
                    ...
                    size="3xl"
                    color="gray" />
                <input type="text" placeholder="Search" className="flex-grow px-5 
                text-base bg-transparent 
                outline-none"/>
            </div>

            <Button
                color="gray" buttonType="outline" rounded={true} iconOnly={true} ripple="dark"
